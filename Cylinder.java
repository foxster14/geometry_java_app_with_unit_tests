...
public class Cylinder {
    ...
    //Calculate top or bottom surface area (aka the top or base) of a cylinder
    public static double baseSurfaceArea (int radius){
        double base = Math.PI * Math.pow(radius, 2);
        return base;
    }
    //Get radius & height from user and print calculations to terminal
    public static void prompt() {

        //the reader object gets input from the terminal
